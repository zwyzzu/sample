 ...
 * File Name: StaticBroadcastreceiber.java
 * Author: 张维亚
 * All Rights Reserved
 * 所有版权保护
...
/**
 * Author: 张维亚
 * 创建时间：2016年2月16日 下午3:25:43
 * 修改时间：2016年2月16日 下午3:25:43
 * Description: 静态注册的BroadcastReceiver
 **/
public class StaticBroadcastReceiver extends BaseBroadcastReceiver {
	...
	public void onReceive(Context ctx, Intent intent) {
		...
		broadcast.putExtra(Common.BUNDLE_REGISTER, ctx.getString(R.string.desc_static_broadcast));
